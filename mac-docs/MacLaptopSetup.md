...
# 2.0 Display Hidden System Files in Finder
...
## 3.3. **Change the theme used by Oh My Zsh**
...
## 3.4. **Install the Powerline fonts 
...
## 3.5. Configure iTerm to use the installed fonts
...
## 6.1. Configure git and GitHub access

### 6.1.1. Setup global configuration
...
### 6.1.2. Enable OSXkeychain as a credential helper
...
### 6.1.3. Creating a personal access token for github
...
### 6.1.4. Creating a personal access token for gitlab
...
### 8.2.1. Install Visual Studio Code
